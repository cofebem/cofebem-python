...
mesh = meshio.read("./msh_files/mycube_refined_edges.msh")
...
# np.savez(
#     "GH_mycube_refined_edges_P1P1.npz",
#     G=G,
#     H=H,
# )
...
data = np.load("GH_mycube_refined_edges_P1P1.npz")
...
meshio.write("mycube_refined_edges_P1P1.vtu", boundary_mesh)
print("Wrote mycube_refined_edges_P1P1.vtu")
