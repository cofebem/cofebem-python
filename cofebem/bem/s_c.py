...
bc_100_y = dirichletbc(np.array([0.0], dtype=np.double), dofs_100[1::3], V)
bc_100_z = dirichletbc(np.array([0.0], dtype=np.double), dofs_100[2::3], V)

bc_010_z = dirichletbc(np.array([0.0], dtype=np.double), dofs_010[2::3], V)
...
# from cofebem.bem.integrate import integrate, shape_functions, map_to_physical_3d
...
#     enumerate(I_Gamma), total=n_collocs, desc="Assembling global matrices"
# ):
